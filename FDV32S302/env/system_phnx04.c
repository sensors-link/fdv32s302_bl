...
/** @defgroup FDV32S302_System
  * @{
  */

/** @defgroup FDV32S302_System_Private_Defines
  * @{
  */

#ifndef _BAUD_FREQ
#define _BAUD_FREQ 115200 /*!< Default serial port baud rate. */
#endif
/**
  * @}
  */

/** @addtogroup FDV32S302_System_Private_Variables
  * @{
  */
...
/** @defgroup FDV32S302_System_Private_Functions
  * @{
  */
...
//	SystemCoreClockUpdate();
	...
	/*------------------- UART_RX GP06 -------------------*/
	IOM_InitStructure.IOM_Pin	  = GPIO_PIN6;
	...
	/*------------------- UART_TX GP07 -------------------*/
	IOM_InitStructure.IOM_Pin	  = GPIO_PIN7;
	IOM_InitStructure.IOM_OutCmd  = DISABLE;
	IOM_InitStructure.IOM_PuCmd	  = DISABLE;
	IOM_InitStructure.IOM_PdCmd	  = DISABLE;
	IOM_InitStructure.IOM_OutType = IOM_OTYPE_COMS;
	...
	/*------------------- UART_RX GP14 -------------------*/
	IOM_InitStructure.IOM_Pin	  = GPIO_PIN14;
	IOM_InitStructure.IOM_OutCmd  = DISABLE;
	IOM_InitStructure.IOM_PuCmd	  = DISABLE;
	IOM_InitStructure.IOM_PdCmd	  = DISABLE;
	IOM_InitStructure.IOM_OutType = IOM_OTYPE_COMS;
	...
	/*------------------- UART_TX GP15 -------------------*/
	IOM_InitStructure.IOM_Pin	  = GPIO_PIN15;
	IOM_InitStructure.IOM_OutCmd  = DISABLE;
	IOM_InitStructure.IOM_PuCmd	  = DISABLE;
	IOM_InitStructure.IOM_PdCmd	  = DISABLE;
	IOM_InitStructure.IOM_OutType = IOM_OTYPE_COMS;
