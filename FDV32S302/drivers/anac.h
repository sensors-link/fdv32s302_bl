...
/* LED_CFG */
#define ANAC_LED_CFG_LEDOPT		 	BITS(16, 20)
#define ANAC_LED_CFG_BLEDRANGE_SEL 	BIT(15)
#define ANAC_LED_CFG_IRLEDRANGE_SEL BIT(14)
#define ANAC_LED_CFG_LED_SEL	  	BIT(13)
#define ANAC_LED_CFG_LED_TEMP_SEL	BIT(12)
...
#define ANAC_LED_CFG_LEDOPT_pos	   (16)
#define ANAC_LED_CFG_IBULE_CC_pos  (7)
#define ANAC_LED_CFG_IIRLED_CC_pos (1)

/* PDSENS_CFG */
#define ANAC_PDSENS_CFG_CHRG BIT(9)
#define ANAC_PDSENS_CFG_GC	 BITS(2, 8)
...
#define ANAC_CMP_CFG_VIPSEL_V1P5D  (7 << 2)
...
#define ANAC_ADC_CFG_VOLTREF_VRSEL BITS(1, 2)
...
#define ANAC_ADC_CFG_ADC_CHSEL_VCC		 (14 << 7)
#define ANAC_ADC_CFG_ADC_CHSEL_VSS		 (15 << 7)

#define ANAC_ADC_CFG_ADC_VRSEL_EXT_VREF (0 << 4)
#define ANAC_ADC_CFG_ADC_VRSEL_INT_VREF (1 << 4)
#define ANAC_ADC_CFG_ADC_VRSEL_VCC		(2 << 4)

#define ANAC_ADC_CFG_VOLTREF_VRSEL_2P0 (0 << 1)
#define ANAC_ADC_CFG_VOLTREF_VRSEL_2P2 (1 << 1)
#define ANAC_ADC_CFG_VOLTREF_VRSEL_2P3 (2 << 1)
...
#define ANAC_LVD_CFG_SRCSEL_LP_VCC (0 << 1)
...
/* DLY_CFG */
#define ANAC_DLY_CFG_LED_STA_DLY	BITS(28, 29)
...
#define ANAC_DLY_CFG_LED_STA_DLY_10   (0 << 28)
#define ANAC_DLY_CFG_LED_STA_DLY_20   (1 << 28)
#define ANAC_DLY_CFG_LED_STA_DLY_50   (2 << 28)
#define ANAC_DLY_CFG_LED_STA_DLY_500  (3 << 28)
...
#define ANAC_DLY_CFG_LED_STA_DLY_pos	(28)
...
typedef struct
{
	u8 LVD_FilterTime; 						/*!< Specify low voltage detection LVD_OUT filter time.
												 This parameter is an 8-bit value. */
...
/** @defgroup LED_temp_gear
  * @{
  */

#define TEMP_GEAR_SEL_LOW   (0)
#define TEMP_GEAR_SEL_HIGH  (1)

#define IS_LED_TEMPGEAR(TEMPGEAR) ((TEMPGEAR) == TEMP_GEAR_SEL_LOW || (TEMPGEAR) == TEMP_GEAR_SEL_HIGH)
/**
  * @}
  */

/** @defgroup LED_temp_coefficient
  * @{
  */

#define IS_LED_TEMPCOEFFICIENT(TEMPCOEFFICIENT) ((TEMPCOEFFICIENT) <= 0x1F)
/**
  * @}
  */
...
/** @defgroup LED_current_gear
  * @{
  */

#define LED_GEAR_SEL_15MA   (0)
#define LED_GEAR_SEL_7P8MA  (1)

#define IS_LED_CURRENTGEAR(CURRENTGEAR) ((CURRENTGEAR) == LED_GEAR_SEL_15MA || (CURRENTGEAR) == LED_GEAR_SEL_7P8MA)
/**
  * @}
  */
...
#define IS_PDSENS_GAINVAL(GAINVAL) ((GAINVAL) <= 0x7F)
/**
  * @}
  */
...
#define IS_CMP_VIPSEL(VIPSEL)                                                                                          \
	((VIPSEL) == CMP_VIP_SEL_VC1P0 || (VIPSEL) == CMP_VIP_SEL_VC1P1 || (VIPSEL) == CMP_VIP_SEL_VC1P2 ||                \
	 ...
	 (VIPSEL) == CMP_VIP_SEL_VBGA || (VIPSEL) == CMP_VIP_SEL_V1P5D)
/**
  * @}
  */
...
#define ADC_CHN_VCC		  (14)
#define ADC_CHN_VSS		  (15)
...
#define IS_ADC_CHANNEL(CHANNEL)                                                                                        \
	(((CHANNEL) == ADC_CHN_AIN0) || ((CHANNEL) == ADC_CHN_AIN1) || ((CHANNEL) == ADC_CHN_AIN2) ||                      \
	 ...
	 ((CHANNEL) == ADC_CHN_PD_VO) || ((CHANNEL) == ADC_CHN_VBGS) || ((CHANNEL) == ADC_CHN_VCC) || 					   \
	 ((CHANNEL) == ADC_CHN_VSS))
/**
  * @}
  */
...
#define ADC_VREF_SEL_INT (1)
#define ADC_VREF_SEL_VCC (2)

#define IS_ADC_VREFSEL(VREFSEL)                                                                                        \
	(((VREFSEL) == ADC_VREF_SEL_EXT) || ((VREFSEL) == ADC_VREF_SEL_INT) || ((VREFSEL) == ADC_VREF_SEL_VCC))
/**
  * @}
  */
...
#define ADC_VREF_VOLT_2P0 (0)
#define ADC_VREF_VOLT_2P2 (1)
#define ADC_VREF_VOLT_2P3 (2)
#define ADC_VREF_VOLT_2P5 (3)

#define IS_ADC_VREFVOL(VREFVOL)                                                                                        \
	(((VREFVOL) == ADC_VREF_VOLT_2P0) || ((VREFVOL) == ADC_VREF_VOLT_2P2) || ((VREFVOL) == ADC_VREF_VOLT_2P3) ||       \
...
#define IS_AINSEL_MULTIPLEXSEL(MULTIPLEXSEL)                                                                           \
	(((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P04_SEL_VC1P1) || ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P04_SEL_AIN02) ||       \
	 ...
	 ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P15_SEL_ATS0)  || ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P15_SEL_ATVC)  ||       \
	 ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P16_SEL_VC1P3) || ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P16_SEL_AIN08) ||       \
	 ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P17_SEL_VC1N2) || ((MULTIPLEXSEL) == AINSEL_MULTIPLEX_P17_SEL_AIN06) ||       \
...
/** @defgroup DLY_PD_reset_to_LED_time
  * @{
  */

#define DLY_PD_RST2LED_DLY_10  (0)
#define DLY_PD_RST2LED_DLY_20  (1)
#define DLY_PD_RST2LED_DLY_50  (2)
#define DLY_PD_RST2LED_DLY_500 (3)

#define IS_DLY_PDRST2LEDDLY(PDRST2LEDDLY)                                                                                \
	(((PDRST2LEDDLY) == DLY_PD_RST2LED_DLY_10) || ((PDRST2LEDDLY) == DLY_PD_RST2LED_DLY_20) ||  						 \
	 ((PDRST2LEDDLY) == DLY_PD_RST2LED_DLY_50) ||((PDRST2LEDDLY) == DLY_PD_RST2LED_DLY_500))
/**
  * @}
  */
...
#define IS_ME_AUTOMODE(AUTOMODE)                                                                                       \
	(((AUTOMODE) == ME_AUTO_MODE_GENERRAL) || ((AUTOMODE) == ME_AUTO_MODE_DARKCURRENT) ||                                     \
	 ((AUTOMODE) == ME_AUTO_MODE_SMOKE))
/**
  * @}
  */
...
void	   LED_TempCoefficientConfig(u8 TempGear, u8 TempCoefficient);
void	   LED_DriveCurrentConfig(u8 LED_Sel, u8 CurrentGear, u8 CurrentVal);
...
void	   LVD_TriggerResetCmd(FunctionalState NewState);
...
void	   DLY_PDRst2LEDDelayConfig(u8 PDRst2LEDDelayTime);
void	   DLY_LEDOpenWidthConfig(u8 OpenWidth);
void	   DLY_SmokeDelayConfig(u8 SmokeDelayTime);
void	   DLY_PDRstDelayConfig(u8 PDRstDelayTime);
