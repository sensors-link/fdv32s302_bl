...
#define SYSC_CLKCTRCFG_SYS_CLK_SEL_HRC (0 << 0)
#define SYSC_CLKCTRCFG_SYS_CLK_SEL_LRC (1 << 0)
...
#define SYSC_CLKENCFG_LPTIM_CK	  BIT(16)
...
#define SYSC_MSFTRSTCFG_TWC	   BIT(8)
#define SYSC_MSFTRSTCFG_ANAC   BIT(7)
#define SYSC_MSFTRSTCFG_HCLK   BIT(6)
#define SYSC_MSFTRSTCFG_TIM2   BIT(5)
#define SYSC_MSFTRSTCFG_TIM1   BIT(4)
#define SYSC_MSFTRSTCFG_TIMER  BIT(3)
#define SYSC_MSFTRSTCFG_UART2  BIT(2)
#define SYSC_MSFTRSTCFG_UART1  BIT(1)
#define SYSC_MSFTRSTCFG_SPI	   BIT(0)
...
#define SYSC_ANCLKDIV_ADC_CLK_DIV_pos  (0) /* 0-0f:div(x*2) */
...
#define SYSC_MOUDLE_CLOCK_LPTIM_CK	  BIT(16)
...
#define SYSC_MOUDLE_CLOCK_ALL                                                                                          \
	(SYSC_MOUDLE_CLOCK_TWC_MRCK | SYSC_MOUDLE_CLOCK_TWC | SYSC_MOUDLE_CLOCK_LPTIM_CK | SYSC_MOUDLE_CLOCK_LPTIM |       \
	 SYSC_MOUDLE_CLOCK_WDT | SYSC_MOUDLE_CLOCK_ANAC | SYSC_MOUDLE_CLOCK_DCLK | SYSC_MOUDLE_CLOCK_IOM |                 \
...
#define SYSC_RESET_MOUDLE_TWC	 BIT(8)
#define SYSC_RESET_MOUDLE_ANAC	 BIT(7)
#define SYSC_RESET_MOUDLE_HCLK	 BIT(6)
#define SYSC_RESET_MOUDLE_TIM2	 BIT(5)
#define SYSC_RESET_MOUDLE_TIM1	 BIT(4)
#define SYSC_RESET_MOUDLE_TIMER	 BIT(3)
#define SYSC_RESET_MOUDLE_UART2	 BIT(2)
#define SYSC_RESET_MOUDLE_UART1	 BIT(1)
#define SYSC_RESET_MOUDLE_SPI	 BIT(0)

#define SYSC_RESET_MOUDLE_ALL                                                                                          \
	(SYSC_RESET_MOUDLE_DIG | SYSC_RESET_MOUDLE_TWC | SYSC_RESET_MOUDLE_ANAC | SYSC_RESET_MOUDLE_HCLK |                 \
	 SYSC_RESET_MOUDLE_TIM2 | SYSC_RESET_MOUDLE_TIM1 | SYSC_RESET_MOUDLE_TIMER | SYSC_RESET_MOUDLE_UART2 | 			   \
	 SYSC_RESET_MOUDLE_UART1 | SYSC_RESET_MOUDLE_SPI)
