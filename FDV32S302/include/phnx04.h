...
typedef struct
{
	...
	__IO unsigned int ANCLKDIV;	   /*!< Offset: 0x14  SYSC ANAC Clock Divider Register */
	__IO unsigned int TIMCLKDIV;   /*!< Offset: 0x18  SYSC timer clock divider register */
	__IO unsigned int RSTSTS;	   /*!< Offset: 0x1C  SYSC reset status register */
} SYSC_TypeDef;
...
typedef struct
{
	...
	__IO unsigned int STARBLOW;	 /*!< Offset: 0x04  TWC Start bit low level configuration register */
	__IO unsigned int STARBHIG;	 /*!< Offset: 0x08  TWC Start bit high level configuration register */
	__IO unsigned int DATABLOW;	 /*!< Offset: 0x0C  TWC Data bit low level configuration register */
	__IO unsigned int DAT0BHIG;	 /*!< Offset: 0x10  TWC Data bit 0 high level configuration register */
	__IO unsigned int DAT1BHIG;	 /*!< Offset: 0x14  TWC Data bit 1 high level configuration register */
	__IO unsigned int SPACEHIG;	 /*!< Offset: 0x18  TWC Space high level configuration register */
	__IO unsigned int TXMASK;	 /*!< Offset: 0x1C  TWC Data return location configuration register */
	__IO unsigned int RXMASK;	 /*!< Offset: 0x20  TWC Data receiving location configuration register */
	__IO unsigned int CMD[12];	 /*!< Offset: 0x24  TWC hardware decode instruction register */
	__IO unsigned int SWCR;		 /*!< Offset: 0x54  TWC SWAN_BUS Control Register */
	__IO unsigned int SWBR;		 /*!< Offset: 0x58  TWC SWAN_BUS Baud Rate Register */
	__I unsigned int  RXD;		 /*!< Offset: 0x5C  TWC receive data register */
	__IO unsigned int RETUN_TXD; /*!< Offset: 0x60  TWC Code return area/SWBUS send data register */
	__IO unsigned int TRANS_TXD; /*!< Offset: 0x64  TWC Code transmit area send data register */
	__IO unsigned int TXS;		 /*!< Offset: 0x68  TWC software transmit start register */
	__IO unsigned int INTEN;	 /*!< Offset: 0x6C  TWC Interrupt Enable Register */
	__IO unsigned int STS;		 /*!< Offset: 0x70  TWC Status Register */
	__I unsigned int  DBG;		 /*!< Offset: 0x74  TWC debug register */
} TWC_TypeDef;
...
typedef struct
{
	__IO unsigned int DATAIN;		/*!< Offset: 0x00  IO data input register */
	...
	__IO unsigned int LS_SYNC;		/*!< Offset: 0x34  IO Level input synchronization enable register */
	__IO unsigned int DEBCE;		/*!< Offset: 0x38  IO port debuffeting control register */
	__IO unsigned int DATAOUT;		/*!< Offset: 0x3C  IO data output register */
} IOM_TypeDef;
...
typedef struct
{
	...
	__I unsigned int  RSV0;		  		/*!< Offset: 0x0C  ANAC reserved register 0 */
	...
	__IO unsigned int LVD_CFG;	  		/*!< Offset: 0x1C  ANAC LVD Configuration Register */
	__IO unsigned int CLK_CFG;	  		/*!< Offset: 0x20  ANAC Clock Control Configuration Register */
	__IO unsigned int AINSEL;	  		/*!< Offset: 0x24  ANAC Analog IO alternate function selection register */
	__IO unsigned int DLY_CFG;	  		/*!< Offset: 0x28  ANAC Delay Configuration Register */
	__IO unsigned int ME_CTL;	  		/*!< Offset: 0x2C  ANAC Measurement Control Register */
	__IO unsigned int ANAC_FLAG;  		/*!< Offset: 0x30  ANAC Interrupt Status Register */
	__IO unsigned int THR1_DATA;  		/*!< Offset: 0x34  ANAC Threshold register 1 */
	__IO unsigned int THR2_DATA;  		/*!< Offset: 0x38  ANAC Threshold register 2 */
	...
	__IO unsigned int RSV2;  			/*!< Offset: 0xA8  ANAC reserved registers 2 */
	...
	__IO unsigned int RSV3;  			/*!< Offset: 0xB4  ANAC reserved registers 3 */
